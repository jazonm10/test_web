...
<body>
 ...
 <div class="main">
    <div class="content">
		...
		echo form_open('products/add_products',  $attribute); 
		...
		?>
							...
							<div>
						    	...
						    	<span>
										...
										echo form_dropdown('category', $options, '','class="category"');
					    	...
					    	<div>
								...
								<?php echo form_input(array('id'=>'product_name', 'name'=>'product_name', 'required'=>'required', 'class'=>'textbox')); ?>
								</span>
						    </div>
						    
							
						    <div>
						     	<span><label>Interest</label></span>
						    	<span>
								
								
								<?php echo form_input(array('id'=>'product_interest', 'name'=>'product_interest', 'class'=>'textbox')); ?>
								
								</span>
						    </div>
							
							<div>
						     	<span><label>Descrition</label></span>
						    	<span>
							...
							<div>
						     	<span><label>Guidelines</label></span>
						    	<span>
								<?php echo form_textarea(array('id'=>'product_guide', 'name'=>'product_guide', 'class'=>'form-control')); ?>  
