...
<body>
 ...
 <div class="main">
    <div class="content">
		...
		echo form_open('account/add_accounts',  $attribute); 
		...
		?>
						    ...
						    <div>
								...
								<?php echo form_input(array('id'=>'account_name', 'name'=>'account_name', 'class'=>'textbox')); ?>
							...
							<div>
								...
								<?php echo form_input(array('id'=>'account_user', 'name'=>'account_user', 'class'=>'textbox')); ?>
							...
							<div>
								...
								<?php echo form_password(array('id'=>'account_pass', 'name'=>'account_pass', 'class'=>'password')); ?>
