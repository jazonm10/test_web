...
<body>
 ...
 <div class="main">
    <div class="content">
		...
		echo form_open('activity/add_activity',  $attribute); 
		...
		?>
					    	...
					    	<div>
								...
								<?php echo form_input(array('id'=>'activity_name', 'name'=>'activity_name', 'required'=>'required', 'class'=>'textbox')); ?>
								</span>
						    </div>
							...
							<div>
						    	...
						    	<span>
								<?php echo form_textarea(array('id'=>'activity_content', 'name'=>'activity_content', 'class'=>'form-control')); ?>  
