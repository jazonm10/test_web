...
<body>
 ...
 <div class="main">
    <div class="content">
		...
		echo form_open('banner/add_banner',  $attribute); 
		
		?>
						
							<div>
						    	<span><label>Banner Name</label></span>
						    	<span>
										...
										$options[$item['banner_id']] = $item['banner_name'];
										}
										
										echo form_dropdown('banner_id', $options, '','class="category"');
					    	...
					    	<div>
								...
								<?php echo form_input(array('id'=>'banner_name', 'name'=>'banner_name', 'required'=>'required', 'class'=>'textbox')); ?>
								</span>
						    </div>
							...
							<div>
						    	...
						    	<span>
								<?php echo form_textarea(array('id'=>'banner_desc', 'name'=>'banner_desc', 'class'=>'form-control')); ?>  
